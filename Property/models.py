...
class City(models.Model):
    ...
    created_at = models.DateTimeField(auto_now_add=True)
    state = models.ForeignKey(State, on_delete= models.CASCADE, related_name="state",default= -1, db_column='state_id')
    def __str__(self):
        return self.name
...
class Listing(models.Model):
    ...
    city = models.ForeignKey(City, on_delete= models.CASCADE, related_name="city",default= -1, db_column='city_name')
    state = models.ForeignKey(State, on_delete= models.CASCADE, related_name="class_state",default= -1, db_column='state_name')
